...
while True:
    ...
    text_x = frame.shape[1] - text_size[0] - 10  # 오른쪽 여백 10 픽셀
    text_y = frame.shape[0] - 10  # 하단 여백 10 픽셀

    # 검은색 음영 텍스트
    cv2.putText(frame, timestamp, (text_x + 2, text_y + 2), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 0), 2, cv2.LINE_AA)
    # 흰색 텍스트
    cv2.putText(frame, timestamp, (text_x, text_y), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2, cv2.LINE_AA)
